...
class AlertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alert" do
    assert_difference('Alert.count') do
      post alerts_url, params: { alert: { category_id: @alert.category_id, user_id: @alert.user_id } }
    end
  ...
  test "should update alert" do
    patch alert_url(@alert), params: { alert: { category_id: @alert.category_id, user_id: @alert.user_id } }
